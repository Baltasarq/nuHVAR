...
package com.devbaltasarq.nuhvar.view.adapters;
...
import com.devbaltasarq.nuhvar.view.ResultsActivity;
...
public class ListViewResultArrayAdapter extends ArrayAdapter<Result> {
    ...
    public @NonNull View getView(int position, View rowView, @NonNull ViewGroup parent)
    {
        ...
        final ImageButton BT_EXPORT_RESULT = rowView.findViewById( R.id.btShareResult );
        ...
        BT_EXPORT_RESULT.setOnClickListener( (v) -> CONTEXT.shareResult( RES ) );
        BT_SHOW_RESULTS.setOnClickListener( (v) -> CONTEXT.showGraph( RES ) );
